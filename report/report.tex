...
tout au long du rapport. Cette image est disponible dans l'implementation SIFT
...
\begin{itemize}
\item \texttt{emu} : permerts d'émuler CUDA (afin de pouvoir executer les
...
passe d'une octave à une autre en sous-échantillonant une image de l'octave
précédente.
